...
import com.kee.common.core.utils.file.FileTypeUtils;
import com.kee.common.core.utils.file.ImageUtils;
import com.kee.common.core.utils.reflect.ReflectUtils;
 ...
 * @author zms
 */
public class ExcelTitleUtil<T> {


    private static final Logger log = LoggerFactory.getLogger(ExcelTitleUtil.class);
    ...
    public ExcelTitleUtil(Class<T> clazz) {
        this.clazz = clazz;
    }
    ...
    public void exportExcel(OutputStream outputStream) {
        try {
            ...
            for (int index = 0; index <= sheetNo; index++) {
                ...
                cell.setCellValue(this.sheetName);
